...
std::unordered_map<std::string, std::vector<long> > minHashSignaturesComparisons(std::unordered_map<std::string,std::set<std::uint32_t> >, std::vector<int>, std::vector<int>);
