...
std::unordered_map<std::string, std::vector<long> > minHashSignaturesComparisons(std::unordered_map<std::string,std::set<std::uint32_t> > shingles_map, std::vector<int> coeffA, std::vector<int> coeffB){
  /**
  * Return a map of all the sequences with their minHash signatures
  *
  * shingles_map : the map of shingles sets with their name
